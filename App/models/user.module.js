...
const userSchema = new mongoose.Schema({
    ...
    completedTracks: [{ type: mongoose.Schema.Types.ObjectId, ref: "Track" }],
    activity: [{
    ...
    completedTrackQuizzes: [{ type: mongoose.Schema.Types.ObjectId, ref: "Track" }],
    enteredLessons: [{ type: mongoose.Schema.Types.ObjectId, ref: "Lesson" }],
    completedQuizzes: [{
        quizId: String,
        score: Number,
        total: Number,
